...
Build project, by running `mvn clean package`, this will provide you the latest versions of the artifacts - 1.8, add it to your classpath. You could select which version to use - Russian or English.
...
Just add _morphology-1.8.jar_ in your Solr lib-directories
